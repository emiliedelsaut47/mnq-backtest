...
with st.sidebar.form(key="trade_form", clear_on_submit=True):
    ...
    if not saisie_rapide:
        ...
        # Nouvelles options pour les bougies
        options_bougies = ["petite mèche", "grosse mèche", "pin bar", "corps"]
...
with tab_correction:
    ...
    if df_incomplets.empty:
        ...
        with st.form(key="formulaire_enrichissement_final"):
            ...
            with col_u3:
                options_bougies_u = ["petite mèche", "grosse mèche", "pin bar", "corps"]
